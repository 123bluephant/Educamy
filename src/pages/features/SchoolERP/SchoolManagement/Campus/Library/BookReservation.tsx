...
const initialReservations = [
  { id: 1, student: 'John Doe', book: 'Mathematics', date: '2024-07-01', status: 'Reserved' },
  { id: 2, student: 'Jane Smith', book: 'Physics', date: '2024-07-02', status: 'Collected' },
];

const BookReservation: React.FC = () => {
  const [reservations, setReservations] = useState(initialReservations);
  const [showModal, setShowModal] = useState(false);
  const [form, setForm] = useState({ student: '', book: '', date: '', status: 'Reserved' });

  const handleAdd = () => {
    setReservations([...reservations, { ...form, id: Date.now() }]);
    setForm({ student: '', book: '', date: '', status: 'Reserved' });
    setShowModal(false);
  };
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="max-w-4xl mx-auto mt-8 bg-white rounded-xl shadow-lg p-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Book Reservation</h1>
            ...
            <div className="bg-white p-6 rounded-xl w-full max-w-md">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end space-x-2">
                  ...
                  <button onClick={handleAdd} className="px-4 py-2 bg-blue-600 text-white rounded-lg">Reserve</button>
                </div>
              </div>
            </div>
          </div>
